Este é um projeto simples de IA generativa utilizando **GPT-2** da Hugging Face para gerar textos automaticamente com base em um prompt fornecido pelo usuário.
